...
---@class CommonTipControl
local CommonTipControl = Class()

function CommonTipControl:ctor(gameObject)
...
---释放
function CommonTipControl:OnDestroy()
	for i, v in pairs(CommonTipControl) do
		if type(v) ~= "function" then
			CommonTipControl[i] = nil
		end
	end
end

return CommonTipControl