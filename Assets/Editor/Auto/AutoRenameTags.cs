...
public static class AutoRenameTags
{
	...
	static void AddTag()
	{
		...
		AddTag(TagLayer.UI_LuaDataTemplate);

		AddTag(TagLayer.UI_LuaView);
		AddTag(TagLayer.UI_LuaViewData);

		AddTag(TagLayer.UI_LuaPanel);
		AddTag(TagLayer.UIScene_LuaView);
	...
	static void AddSortingLayer()
	{
		...
		{
			Hukiry.HukiryLayer.AddSortingLayer(ObjectSortingLayers.SortingLayers[i], i);
		}
	}
