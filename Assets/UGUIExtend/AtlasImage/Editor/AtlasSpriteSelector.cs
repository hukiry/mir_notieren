...
namespace Hukiry.UI {
    ...
    public class AtlasSpriteSelector : ScriptableWizard
    {
        ...
        public static void Show(SpriteAtlas spriteAtlas,string defaultSpriteName, OnSpriteSelected callback)
        {
			...
			selector.mSearchText = AtlasImageAssetSetting.Instance.searchSpriteName;
        ...
        void OnGUI()
        {
            ...
            {
                bool close = false;
                if(sprites!=null) GUILayout.Label(atlas.name + " Sprites ["+sprites.Length+"]", "LODLevelNotifyText");
                else GUILayout.Label(atlas.name + " Sprites", "LODLevelNotifyText");
                GUILayout.Space(12f);
                ...
                GUILayout.BeginHorizontal();
                {
                    ...
                    {
                        mSearchText = "";
                        AtlasImageAssetSetting.Instance.searchSpriteName = mSearchText;
                ...
                //排序
                List<Sprite> spriteList = sprites.Where(p=>p!=null).ToList();
                ...
                mScrollPos = GUILayout.BeginScrollView(mScrollPos);
                {
                    ...
                    while (offset < spriteList.Count)
                    {
                        GUILayout.BeginHorizontal();
                        {
                            ...
                            {
                                Sprite sprite = spriteList[offset];
                                ...
                                GUI.Label(new Rect(rect.x, rect.y + rect.height, rect.width, 24f), spriteName, "ProgressBarBack");
        ...
        internal static void Show(SpriteAtlas spriteAtlas, object spriteName, Action<string> p)
        {
