...
{
	public const string TOPDIR = "/Lua";

	public static string luaDir = Application.dataPath.Replace("Assets", "LuaScript");            //lua逻辑代码目录
	public static string toluaDir = Application.dataPath.Replace("Assets", "LuaScript");     //tolua lua文件目录
