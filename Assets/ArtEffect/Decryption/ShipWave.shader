Shader"Decryption/ShipWave"
{
    ...
    SubShader
    {
        ...
        pass
        {
            ...
            #pragma multi_compile _MASKENABLED_ON
            #pragma multi_compile _DISTORTENABLED_ON
            ...
            float _Distort, _DistortUVSpeedX, _DistortUVSpeedY, _WaveSpeed;
            ...
            v2f vert(appdata v)
            {
                ...
                o.color = v.color;
                o.uv.xy = TRANSFORM_TEX(v.uv, _MainTex) + float2(_MainUVSpeedX, _MainUVSpeedY) * sin(frac(_Time.y * _WaveSpeed) * 6.283185);
            ...
            fixed4 frag(v2f i): SV_TARGET
            {
                ...
                fixed4 c;
                c = _MainColor * _Intensity * _MainColor.a * i.color.r * i.color.a;
