...
#pragma warning restore 414
        ...
        void OnEnable()
        {
            ...
            if (_settings==null) _settings = this.GetAssetObject<DOTweenSettings>(nameof(DOTweenSettings));
        ...
        private T GetAssetObject<T>(string fileName) where T : UnityEngine.Object
        {
        ...
        override public void OnInspectorGUI()
        {
            ...
            if (_settings == null)
            {
                _settings = this.GetAssetObject<DOTweenSettings>(nameof(DOTweenSettings));
            }
